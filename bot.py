#!/usr/bin/env python3
# TELEGRAM BOT — CUSTOM EMOJI (TERI IDs)
...
EMOJI = {
    "sparkles": "6089104607328342288",      # 💰
    "check": "6089364701957853465",         # ✅
    "crown": "6089003761496232797",         # 👑
    "warning": "4956611513369494230",       # ⚠️
    "play": "4956250031741993892",          # ▶️
    "clock": "4956720180337050608",         # 🕽
    "gift": "4956722293460960020",          # 🎀
    "lightning": "6087079590377820415",     # ⚡
}
...
{e('check')} <b>Features:</b>
   • All custom premium emojis
   • Interactive buttons
   • Fast response

{e('gift')} <b>Made with ❤️ by UNKNOWNBABU 10X</b>
        """
        await query.edit_message_text(msg, parse_mode="HTML")
...
{e('check')} /start — Welcome message
{e('check')} /help — This help
...
def main():
    ...
    ╔═══════════════════════════════════════════════════════════════════╗
    ║                                                                   ║
    ║      🔥 CUSTOM EMOJI BOT — TERI IDs 🔥                           ║
    ║                                                                   ║
    ║   Owner: @unknown_tanveer | UNKNOWNBABU 10X                       ║
    ║                                                                   ║
    ║   Emoji IDs: 8 Custom Premium Emojis                             ║
    ║   Bot Token: 8929527790:AAEFyNqSWbqzntDZmqockyix0gbkuY5WAMA      ║
    ║                                                                   ║
    ╚═══════════════════════════════════════════════════════════════════╝
    """)
    ...
    print("✅ Bot is running with your custom emojis...")
    app.run_polling()
